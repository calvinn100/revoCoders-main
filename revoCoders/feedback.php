...
<div class="col-md-10">
<a href="mailto:calvintendai@gmail.com" style="color:#000000">calvin@aplimac.co.zw</a><br /><br />
...
<a href="http://www.aplimac.co.zw" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
<a href="#" data-toggle="modal" data-target="#login">Admin Login</a></div>
<div class="col-md-3 box">
<a href="http://www.aplimac.co.zw" data-toggle="modal" data-target="#developers">Developers</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.jpg" width=100 height=100 alt="calvin" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://www.facebook.com/aplimactech" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Aplimac Technologies</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+263773330211</h4>
		<h4 style="font-family:'typo' ">calvin@aplimac.co.zw</h4>
		<h4 style="font-family:'typo' ">Aplimac Technologies</h4></div></div>
		</p>
      </div>
